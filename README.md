...
一个基于关帝灵签100签的在线求签网页应用，纯前端实现，无需服务器，开箱即用。
...
直接访问：[https://austinnie.github.io/guandi-sign/](https://austinnie.github.io/guandi-sign/)

### 本地运行

```bash
# 1. 克隆仓库
git clone git@github.com:austinnie/guandi-sign.git
